...
func main() {
	...
	r.Group(func(r chi.Router) {
		...
		r.Get("/admin/skills", handlers.GetSkills)
		r.Post("/admin/skills/categories", handlers.CreateSkillCategory)
		r.Get("/admin/skills/categories", handlers.GetSkillCategories)
